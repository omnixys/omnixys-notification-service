...
> = {
  ...
  meta: {
    modelProps: 'template' | 'notification' | 'deliveryAttempt';
 ...
 */
export type EnumDeliveryAttemptStatusFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'DeliveryAttemptStatus'>;

/**
 * Reference to a field of type 'DeliveryAttemptStatus[]'
 */
export type ListEnumDeliveryAttemptStatusFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'DeliveryAttemptStatus[]'>;
