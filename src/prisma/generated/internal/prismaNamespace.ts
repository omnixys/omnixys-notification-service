...
> = {
  ...
  meta: {
    modelProps: 'tenant' | 'template' | 'templateVersion' | 'notification';
    ...
    TemplateVersion: {
      ...
      operations: {
        ...
        count: {
          ...
          result:
            | runtime.Types.Utils.Optional<Prisma.TemplateVersionCountAggregateOutputType>
            | number;
        };
      };
    };
...
export type TemplateVersionScalarFieldEnum =
  (typeof TemplateVersionScalarFieldEnum)[keyof typeof TemplateVersionScalarFieldEnum];
 ...
 */
export type EnumChannelFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'Channel'
>;
 ...
 * Reference to a field of type 'Channel[]'
 */
export type ListEnumChannelFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'Channel[]'
>;
 ...
 */
export type EnumContentFormatFieldRefInput<$PrismaModel> = FieldRefInputType<
  $PrismaModel,
  'ContentFormat'
>;
 ...
 * Reference to a field of type 'ContentFormat[]'
 */
export type ListEnumContentFormatFieldRefInput<$PrismaModel> =
  FieldRefInputType<$PrismaModel, 'ContentFormat[]'>;
