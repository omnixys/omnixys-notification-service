...
> Repository development instructions for **notification** (Service).
...
src/adapter, admin, analytics, config, core, handlers, health, modules, prisma, security, utils
...
node --test __tests__/unit/*.test.mjs and __tests__/integration/*.test.mjs; Jest e2e

## Repository-Specific Rules

Tenant-aware notifications; delivery/observability relevant.
